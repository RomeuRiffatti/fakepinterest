...
def homepage():
    ...
    if formlogin.validate_on_submit():
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha.encode('utf-8'), formlogin.senha.data): ##Aqui ele compara senha criptografada, o Bcrypt acessa a senha verdadeira atraves da encriptada e compara com a senha passada pelo usuario no formlogin
            login_user(usuario)
